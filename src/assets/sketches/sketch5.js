...
void main() {
    ...
    vec2 q = vec2(0.);
    q.x = fbm( st+vec2(c[0],c[1]*.07*iTime) ); // CAMBIAR A .03 el iTime
...
color = mix(color,vec3(0.16,1.05*(1.0+cos(1.5+.2*iTime)),0.958),r.y+length(q));//
